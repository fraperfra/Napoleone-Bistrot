        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-20 gap-8">
            <div className="max-w-2xl">
              ...
              <h2 className="text-4xl md:text-6xl text-darkGreen mb-6 tracking-tight font-bold">
                {lang === 'it' ? 'La Nostra Cucina' : 'Our Kitchen'}
              </h2>
              <p className="text-darkGreen/60 text-lg md:text-xl italic leading-relaxed">
                {lang === 'it' 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 group relative h-[400px] md:h-auto overflow-hidden rounded-[3rem] shadow-xl border border-darkGreen/5 cursor-pointer" onClick={() => setActivePage('menu')}>
              ...
              <div className="absolute bottom-0 left-0 p-8 md:p-12 w-full">
                ...
                <h3 className="text-3xl md:text-4xl text-white mb-4 font-bold">Risotto all'Amarone</h3>
