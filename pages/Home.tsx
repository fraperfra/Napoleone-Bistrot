      ...
      <section className="py-28 bg-white relative overflow-hidden" id="private-events">
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            {/* Side Info Column */}
            <div className="flex flex-col gap-8">
              <div className="bg-cream p-6 md:p-8 rounded-[2.5rem] border border-darkGreen/5 hover:border-gold/30 hover:shadow-2xl transition-all duration-500 group flex flex-row items-center gap-6">
                <div className="shrink-0 bg-white p-3 rounded-2xl shadow-sm text-gold group-hover:bg-gold group-hover:text-darkGreen transition-colors">
                  <Briefcase size={20} />
                </div>
                <div>
                  <h4 className="text-xl md:text-2xl text-darkGreen mb-2 group-hover:text-gold transition-colors font-bold">Business</h4>
                  <p className="text-darkGreen/80 text-sm md:text-base leading-relaxed font-medium">
              ...
              <div className="bg-darkGreen p-6 md:p-8 rounded-[2.5rem] border border-white/5 hover:border-gold/30 hover:shadow-2xl transition-all duration-500 group flex flex-row items-center gap-6 cursor-pointer" onClick={() => setActivePage('contact')}>
                <div className="shrink-0 bg-white/10 p-3 rounded-2xl shadow-sm text-gold group-hover:bg-gold group-hover:text-darkGreen transition-colors backdrop-blur-sm">
                  <PartyPopper size={20} />
                </div>
                <div className="flex-1 text-left">
                  <h4 className="text-xl md:text-2xl text-white mb-2 group-hover:text-gold transition-colors font-bold">{lang === 'it' ? 'Feste Private' : 'Private Parties'}</h4>
                ...
                <div className="shrink-0 w-10 h-10 bg-gold text-darkGreen rounded-full flex items-center justify-center group-hover:scale-110 transition-transform">
                  <ArrowRight size={18} />
                </div>
              </div>
            </div>
