...
// Placeholder for Settings/Dashboard home
const DashboardHome = () => (
    <div className="p-6">
        <h2 className="text-2xl font-serif text-darkGreen font-bold mb-4">Benvenuto nel CMS</h2>
        <p className="text-darkGreen/70">Seleziona una voce dal menu laterale per gestire i contenuti.</p>
    </div>
);
...
const AdminDashboard: React.FC = () => {
  const { logout } = useCMS();
  const [activeTab, setActiveTab] = useState<'dashboard' | 'menu' | 'events' | 'settings'>('dashboard');
